...
import { MoonbeamAdapter, MoonbeamNetworkInfo } from '../adapters/MoonbeamAdapter';
import { SBTContractABI, SBTContractAddress } from './types/SBTContractTypes';
...
export class DeploymentConfigLoader {
  ...
  private constructor() {
    // For React environment, use a simple default configuration
    this.config = { 
      deployments: {
        'moonbase-alpha': {
          contractAddress: process.env.REACT_APP_SBT_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000',

...
describe('DID Wizard Integration Tests', () => {
  ...
  it('persists DID in localStorage after creation', async () => {
    ...
    // Step 6: Should eventually reach authentication success
    await waitFor(() => {
      expect(screen.getByText('Authentication Successful!')).toBeInTheDocument();
    }, { timeout: 5000 });

    // Step 7: Check localStorage for DID
    // The test account address is hardcoded in the mock: '5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty'
    const did = localStorage.getItem('did_5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty');
